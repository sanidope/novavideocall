...
class FirstSection(models.Model):
    ...
    about_pic = ProcessedImageField(upload_to="about_pic/%y/%m/%d", processors=[ResizeToFill(1116, 267)], format='JPEG', options={'quality': 60})
...
class FifthSection(models.Model):
    ...
    leaderpic1 = ProcessedImageField(upload_to="about_pic/leadership/%y/%m/%d", processors=[ResizeToFill(1116, 267)], format='JPEG', options={'quality': 60}, null=True)
    ...
    leaderpic2 = ProcessedImageField(upload_to="about_pic/leadership/%y/%m/%d", processors=[ResizeToFill(1116, 267)], format='JPEG', options={'quality': 60}, null=True)
    ...
    leaderpic3 = ProcessedImageField(upload_to="about_pic/leadership/%y/%m/%d", processors=[ResizeToFill(1116, 267)], format='JPEG', options={'quality': 60}, null=True)
